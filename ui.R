                              ...
                              fluidRow(
                                ...
                                div(id='viz_sidebar', column(4,
                                  ...
                                  bsCollapse(id='viz_sidebar', open = c('peakplots', 'axlabs'), multiple=TRUE, 
                                    ...
                                    bsCollapsePanel(div('Dynamic Options', div(style = 'float:right', uiOutput('dynamic_opts_icon'))), value = 'reactive_plot_opts',
                                      # plot options
                                      wellPanel(
                                ...
                                column(8,
                                  ...
                                  disabled(
                                    div(style = 'display:inline-block',
                                             ...
                                             bsButton('make_goto_linked', label = 'Compare in Linked Plots', icon = icon('link'))
                                    )
                                  ),
