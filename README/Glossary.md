...
**Citations are noted by superscript numbers and are given in full at the bottom of this page.**
...
FTICR R Exploratory Data Analysis (FREDA) is an interactive tool for exploratory data analysis of FTICR data.
...
Fourier-transform ion cyclotron resonance (FTICR) is a type of mass spectrometry that uses the cyclotron frequency of the ions in a fixed magnetic field to determine the mass-to-charge-ratio of ions.
...
Plot of Kendrick Mass Defect (y-axis) versus Kendrick Mass (x-axis)
...
Analytic technique that measures masses within a sample using ionization
...
Standard unit of magnetic flux density
...
Plot of H:C (y-axis) vs O:C (x-axis); also see O:C and H:C
