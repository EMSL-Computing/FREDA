...
install.packages(c("shiny", "shinyBS", "ggplot2", "reshape2","webshot","htmlwidgets","dplyr","raster","magick","purrr", 
                   "DT", "shinyjs", "shinycssloaders", "datadr", "pander", "rmarkdown", "kableExtra", "shinyWidgets", 'vegan', 'ape')) 

webshot::install_phantomjs()

# Can also install from local source if necessary (make sure to list the parent directory of this in "local.repos" above)
devtools::install_local("/Users/clab683/Documents/git_repos/ftmsRanalysis/")
...
packrat::bundle(vdbDir, include.bundles = FALSE)
